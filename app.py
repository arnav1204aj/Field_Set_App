...
with tab1:
    ...
    if submit:
            ...
            with col4:
                try:
                        fig = plot_intrel_pitch_avg(intrel,selected_batter,selected_lengths,selected_bowl_kind,1)     
                        st.pyplot(fig)
                except Exception:
                                st.warning('Unavailable')
            ...
            with col3:
                ...
                try:
                        fig = plot_intrel_pitch('intrel_by_length','Int-Rel',intrel,selected_batter,selected_lengths,selected_bowl_kind,1)     
                        st.pyplot(fig)
                except Exception:
                                st.warning('Unavailable')
            with col2:
                ...
                try:
                        fig = plot_intrel_pitch('reliability_by_length','Reliability',intrel,selected_batter,selected_lengths,selected_bowl_kind,1)     
                        st.pyplot(fig)
                except Exception:
                                st.warning('Unavailable')
            with col1:
                ...
                try:
                        fig = plot_intrel_pitch('intent_by_length','Intent',intrel,selected_batter,selected_lengths,selected_bowl_kind,1)     
                        st.pyplot(fig)
                except Exception:
                                st.warning('Unavailable') 
